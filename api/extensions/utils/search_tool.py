...
@cached(cache)
def get_synonym_dict(type_:str,tenant_id:int = 100) -> dict[str, list[str]]:
    conn = None
    try:
        # 连接PostgreSQL
...
# }
default_synonym_dict = get_synonym_dict(type_='sys');

biz_synonym_dict = get_synonym_dict(type_='biz',tenant_id=101);
