...
default_synonym_dict = {
    "回款": ["收款","收款金额", "款项", "支付", "款项回收","项目回款金额", "回款金额","回款情况"],
    "哪些": ["哪些","多少","有哪些"],
    "工时": ["消耗工时","项目工时","耗费","耗费","花费","消费掉","耗费工时","耗费工时","花费工时","消费掉工时"],
    "项目": ["工程", "Project","项目清单","项目列表","项目情况","项目明细"],
    "指定日期": ["本周", "本月", "上个月", "上周", "上个星期", "上月", "上个月", "下月", "前一周", "过去一周", "最近一周", "七天前", "未来一个月", "下一月", "一个月后", "近三月"],
    ...
    "各项目": ["各项目","每个项目","各个项目","所有项目","激活项目","关闭项目"],
}

new_words = ["航空工业项目","602所","指定日期","某某项目","回款计划","项目工时","回款情况","消耗工时","不匹配","有哪些"]
# 1. 中文分词
...
if __name__ == "__main__":
    ...
    # 获取模糊匹配分数
    match_score = api_desc_match(query, name="某某项目本周回款计划", target_required="本周回款计划", target_un_required="某某项目",word="AB,CD,EF", synonym=synonym )
