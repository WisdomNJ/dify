...
const useConfig = (id: string, payload: FunctionCallNodeType) => {
    const { nodesReadOnly: readOnly } = useNodesReadOnly()
    const { inputs, setInputs } = useNodeCrud<FunctionCallNodeType>(id, payload)
    ...
    const {
        ...
        setRunInputData,
        runResult,
    } = useOneStepRun<FunctionCallNodeType>({
        isPaused: false,
